...
def _make_loader():
    ...
    MyLoader.add_constructor('tag:hughml.org,2002:map', MyLoader.construct_mapping)
...
def _make_canonical_loader():
    ...
    MyCanonicalLoader.add_constructor('tag:hughml.org,2002:map', MyCanonicalLoader.construct_mapping)
