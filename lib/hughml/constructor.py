...
class SafeConstructor(BaseConstructor):
    ...
    def construct_scalar(self, node):
        if isinstance(node, MappingNode):
            for key_node, value_node in node.value:
                if key_node.tag == u'tag:hughml.org,2002:value':
    ...
    def flatten_mapping(self, node):
        ...
        while index < len(node.value):
            ...
            if key_node.tag == u'tag:hughml.org,2002:merge':
            ...
            elif key_node.tag == u'tag:hughml.org,2002:value':
                key_node.tag = u'tag:hughml.org,2002:str'
                index += 1
            else:
                index += 1
        if merge:
...
class FullConstructor(SafeConstructor):
    ...
    def construct_python_long(self, node):
        return long(self.construct_hughml_int(node))
...
FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/none',
    FullConstructor.construct_hughml_null)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/bool',
    FullConstructor.construct_hughml_bool)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/str',
    FullConstructor.construct_python_str)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/unicode',
    FullConstructor.construct_python_unicode)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/int',
    FullConstructor.construct_hughml_int)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/long',
    FullConstructor.construct_python_long)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/float',
    FullConstructor.construct_hughml_float)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/complex',
    FullConstructor.construct_python_complex)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/list',
    FullConstructor.construct_hughml_seq)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/tuple',
    FullConstructor.construct_python_tuple)

FullConstructor.add_constructor(
    u'tag:hughml.org,2002:python/dict',
    FullConstructor.construct_hughml_map)

FullConstructor.add_multi_constructor(
    u'tag:hughml.org,2002:python/name:',
    FullConstructor.construct_python_name)

FullConstructor.add_multi_constructor(
    u'tag:hughml.org,2002:python/module:',
    FullConstructor.construct_python_module)

FullConstructor.add_multi_constructor(
    u'tag:hughml.org,2002:python/object:',
    FullConstructor.construct_python_object)

FullConstructor.add_multi_constructor(
    u'tag:hughml.org,2002:python/object/apply:',
    FullConstructor.construct_python_object_apply)

FullConstructor.add_multi_constructor(
    u'tag:hughml.org,2002:python/object/new:',
